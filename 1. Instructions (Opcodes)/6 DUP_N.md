This will DUP (aka duplicate) the last N elements (the top/the right-most/the last added element) on the stack, and add a copy of them to the top of the stack.
